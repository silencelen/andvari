// Autofill URI matching + field classification (spec 02 §3.1) — TS mirror of
// core/.../client/autofill/UriMatch.kt + FieldClassifier.kt, for the future browser
// extension. Both impls run the SAME spec/test-vectors/urimatch.json.
